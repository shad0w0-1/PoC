...
import { CastUint } from "./lib/CastUint.sol";
import { Capped } from "./lib/Capped.sol";
...
abstract contract BaseVault is IVault, ERC20Permit, ERC4626, Capped {
     ...
     * @inheritdoc IERC4626
     */
    function redeem( // same as withdraw
        uint256 shares,
        address receiver,
        address owner
    ...
    function getWithdrawFeeRatio() public view override returns (uint256) {
        ...
        return Math.min(_withdrawFeeRatio, MAX_WITHDRAW_FEE); // returns the smallest number between the two
    }
